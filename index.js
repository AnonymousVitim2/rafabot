...
const vcard = 'BEGIN:VCARD\n' // JAN MUDOU
            + 'VERSION:3.0\n' // JAN MUDOU
            + 'FN: DONO ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ\n' // NOME DE CONTATO DO PROPRIETÁRIO
            + 'ORG:Criador ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ;\n' // NOME DO CRIADOR
            + 'TEL;type=CELL;type=VOICE;waid=556281212020:+55 62 8121-2020\n' // LU HP NÚMERO
            + 'END:VCARD'
prefix = '#'
blocked = []
		...
		try {
			...
			mess = {
				...
				only: {
					...
					premium: '[❗] ESTE COMANDO É ESPECÍFICO DO USUÁRIO  *PREMIUM* se quiser virar Premium,fale com o meu proprietário wa.me/+556281212020',
					...
					ownerG: '[❗] Proprietário ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ? Este é um recurso especial para o proprietário ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ',
					ownerB: '[❗] Proprietário ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ? Este é um recurso especial para o proprietário ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ ❌',
					userB: `──「 LISTA 」──\nOla mano !\nVocê não está registrado no banco de dados, \n\nComando : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar ZEIN|17\n\n──「 ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ 」──`,
			...
			const ownerNumber = ["556281212020@s.whatsapp.net"]
			const mod = [ownerNumber,"556281212020@s.whatsapp.net"]
			const adminbotnumber = ["556281212020@s.whatsapp.net"]
			const frendsowner = ["556281212020@s.whatsapp.net"]
			const premium = ["556281212020@s.whatsapp.net","552167446481@s.whatsapp.net","553484104285@s.whatsapp.net"]
...
case 'menu11':
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ GROUP*\n\nLink : https://chat.whatsapp.com/5*', text, { quoted: mek })
					break
...
case 'brainly':
			       ...
			       case 'valxlove':
					...
					if (mentioned.length > 1) {
						...
						mentions(`╭────「 *PREMIUM👑* 」──*\n│+ *Número* : @${mentioned[0].split('@')[0]}\n│+ *Expirado*: *30 Days*\n│+ *Status*: *ATIVO*\n│ Obg por comprar o acesso Premium🥰\n*╰──────「 *᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ* 」────`, mentioned, true)
					client.sendMessage(from, mentioned)
				    }
					break
					case 'dellvip':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ ✨* 」\n*│+wa.me/556281212020*╰──────*「 *᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ* 」*────*\n\n*_SE QUER SER ADMINISTRADOR  ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ BOT_*\n*_Tipo / anúncio_*' })
					break
					case 'premiumcek':
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/556281212020*╰──────*「 * ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ* 」*────*\n\n*_SE QUER SE TORNAR UM USUÁRIO PREMIUM  ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ BOT_*\n*_Tipo -daftarvip*' })
					break
					case 'cekmod': 
...
client.sendMessage('./lindy/websexohjmulher.mp3', {quoted: mek, ptt:true})
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                 client.sendMessage(from, {displayname: "᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇??͢𝐏𝜩₃₂₃🌹シ", vcard: vcard}, MessageType.contact, { quoted: mek})
                 client.sendMessage(from, 'esse é meu eh meu dono, chama ele ai po',MessageType.text, { quoted: mek} )
                 tod = await getBuffer(`https://i.ibb.co/s9fZWMB/IMG-20210224-WA0107.jpg`)
            ...
            break
				...
				mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					...
					break
                case 'fakereplay':
                   client.fakeReply("ange mano", "melhor correr", "556281212020", MessageType.text)
                   break
				case 'infogc':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL USER BOT  ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ* 」\n\`\`\``
					no = 0
...
case 'mining':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*/᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シbot2412\n*', text, { quoted: mek })
					break
                case 'ttp':
                if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('556281212020@s.whatsapp.net', options, text, {quoted: mek})
...
case 'tiktok1':
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					mentions('╔══✪〘 Mencione tudo 〙✪══'+teks+'╚═〘  ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ BOT 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ * ᭕̸᬴͜͡🌹𝗥𝗮𝗽𝗵𝗮᭄ঔৣ͡𝐇𝐘͢𝐏𝜩₃₂₃🌹シ Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Transmissão de sucesso')
					}
					break
