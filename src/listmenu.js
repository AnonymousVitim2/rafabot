...
╠══✪〘 ❌FUN❌ 〙✪══ [Manutenção!!]*
║
║ *VÁRIAS COISAS PARA SER TRADUZIDAS*
║
╠➥ *${prefix}tebakgambar*
╠➥ *${prefix}caklontong*
╠➥ *${prefix}family100*
...
╠➥ *${prefix}randomcat*
║
╚═ Tipo *${prefix}info* para ver uma lista de informações sobre o bot
       Tipo *${prefix}owner* para ver os contatos do proprietário
    _* RAFA BOT © 2021*_`
}
